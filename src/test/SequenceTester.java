...
class Sequence {
	...
	public Sequence(String city_name, int duration_threshold, float distance_threshold, int sr, int initPatientNum,
			int objectNum) {
	...
	public void eta(HashSet<Integer> patientIDs) {
		...
		String setInfo = String.format(
				...
				this.city_name,
				Settings.maxProcessDays, this.sr, this.duration_threshold, this.distance_threshold, this.initPatientNum,
				Settings.minMBR);
	...
	public void run() {
		System.out.println(String.format("Running: city_name: %s \t duration_threshold: %d  \t distance_threshold: %f",
				this.city_name,
		...
		if (!this.city_name.equals("beijing")) {
			...
			info = String.format(
					"city_name: %s \t days: %d \t sr: %d \t duration_threshold: %d  \t distance_threshold: %f  \t initPatientNum: %d minMBR: %d",
					this.city_name,
					Settings.maxProcessDays, this.sr, this.duration_threshold, this.distance_threshold,
