...
public class QuadTree {
    ...
    public class CoordHolder {
        ...
        // stored info
        public Location o;
        // the quad cell that covers this coordinate
        public Quad quad;

        public CoordHolder(double x, double y, Location o, Quad quad) {
            this.x = x;
            this.y = y;
            this.o = o;
            this.quad = quad;
        ...
        // remove this from quadtree
        public void remove() {
            if (quad.items.remove(this))
                size--;
        }

        // get the depth of this coordinate in the established quadtree
        public int depth() {
            int i = 0;
            Quad q = this.quad;
            while (q != null) {
    ...
    public class Quad {
        ...
        public void getAllLeafs(List<Quad> leafs) {
            if (UL == null) {
                leafs.add(this);
                return;
            }
            UL.getAllLeafs(leafs);
            UR.getAllLeafs(leafs);
            LL.getAllLeafs(leafs);
            LR.getAllLeafs(leafs);
        }
        ...
        public CoordHolder place(double x, double y, Location o) {
    ...
    public List<Quad> getAllLeafs() {
        List<Quad> leafs = new ArrayList<>();
        if (root != null) {
