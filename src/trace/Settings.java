...
public class Settings {
	...
	public static int duration_threshold = 50; // 设定的感染时长
	public static float distance_threshold = 10f; // 设定的感染距离
	public static String city_name = "beijing";
	public static int objectNum = (city_name == "beijing") ? 10000:1000000; // 初始化物体数目
	public static int initPatientNum = (city_name == "beijing") ? 600:60000;// 初始化病人数目
