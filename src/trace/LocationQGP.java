...
import indexes.LocationQuadTree;
import indexes.LocationQuadTree.CoordHolder;

/**
 * QGP implementation, construct a quadtree for database, use gridindex for
 * query locations
 */
public class LocationQGP {
	...
	public LocationQuadTree dbQuadTree;
	...
	public LocationQGP(double epsilon, int k, String cityname) {
	...
	public void constructIndex(ArrayList<Location> batch) {
		dbQuadTree = new LocationQuadTree();
