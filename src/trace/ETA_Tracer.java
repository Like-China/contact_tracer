...
public class ETA_Tracer {
	...
	// patient ids includes already infected objects and new discoverd cases of
	// exposure
	public HashSet<Integer> patientIDs;
	// infected areas at current timestamp (e.g., at least one patients in this
	// area)
	...
	public ArrayList<Integer> trace(ArrayList<Location> batch) {
		...
		// 2. calculate exact distance among each two non-query locations and query
		// location
